...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Data Source=LAPTOP-870DJRSV;Initial Catalog=FUMiniHotelManagement;User ID=sa;Password=12345;TrustServerCertificate=True");
            }
        }
/*        private string GetConnectionString()
        {
            IConfiguration config = new ConfigurationBuilder()
                 .SetBasePath(Directory.GetCurrentDirectory())
                        ...
                        .Build();
            Console.WriteLine("ssss");Console.WriteLine(new ConfigurationBuilder().SetBasePath(Directory.GetCurrentDirectory()));
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Customer>(entity =>
            {
                ...
                entity.HasIndex(e => e.EmailAddress, "UQ__Customer__49A147404959710C")
                    .IsUnique();
